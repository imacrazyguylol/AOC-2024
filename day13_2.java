...
class day13_2 {
    public static void main(String[] args) throws Exception {
        ...
        while ((line1 = in.readLine()) != null) {
            ...
            long PrizeX, PrizeY;
            s = line3.split(", ");
            PrizeX = Long.parseLong(s[0].substring(9)) + (long) 1e13;
            PrizeY = Long.parseLong(s[1].substring(2)) + (long) 1e13;
    ...
    static class ClawMachine {
        ...
        public ClawMachine(long PrizeX, long PrizeY, int xA, int xB, int yA, int yB) {
            this.PrizeX = PrizeX;
            this.PrizeY = PrizeY;
            this.xA = xA;
            this.xB = xB;
